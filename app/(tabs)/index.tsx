...
import RandomizerClothe from '@/components/RandomizerClothe';
import {Outfit} from "@/classes/outfit"; // Import the RandomizerClothe component

export default function TabOneScreen() {
    const [randomShirt, setRandomShirt] = useState<Clothe | undefined>(undefined);
    const [randomPants, setRandomPants] = useState<Clothe | undefined>(undefined);
    const [randomShoes, setRandomShoes] = useState<Clothe | undefined>(undefined);
    ...
    async function saveOutfit() {
        const outfit = new Outfit("outfit", randomShirt, randomPants, randomShoes);
        await DatabaseController.addOutfit(outfit);
    }
        ...
        <View style={styles.container}>
            ...
            <View style={styles.buttonBox}>
                <TouchableOpacity style={styles.button}>
                    <Text style={styles.buttonText} onPress={saveOutfit}>Save Outfit</Text>
                </TouchableOpacity>
